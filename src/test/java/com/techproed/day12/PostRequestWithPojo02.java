...
import com.techproed.pojos.BookingDatePojo;
...
spec02.pathParam("parametre1","booking");
    BookingDatePojo bookingdates =new BookingDatePojo("2020-09-09","2020-09-21");
    ...
    Response response=given().contentType(ContentType.JSON).spec(spec02).auth().basic("admin","password123").
            body(bookingPojo).when().post("/{parametre1}");
